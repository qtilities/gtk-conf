...
You can reload the new settings by pressing the Reset button, or use Save if you want to keep the current ones.</source>
        <translation>有些設正已被變更，由不同的應用程式。

您可重新載入設定，點按重新設定按鈕；或是使用儲存，若是想保留目前所設。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>是否總是播放任何事件音效。有關事件音效和音效主題的更多信息，請參見音效主題規格。 GTK 本身不支援事件音效，您必須使用像是 Libcanberra 隨附可加載的模組。</translation>
    </message>
    <message>
        ...
        <translation>是否要播放事件音效作為使用者輸入的反應。有關事件音效和音效主題的更多信息，請參見音效主題規格。 GTK 本身不支援事件音效，您必須使用像是 Libcanberra 隨附可載入的模組。</translation>
    </message>
    <message>
        ...
        <translation>所要載入的主題的名稱。有關 GTK 如何找到主題 CSS 樣式的詳細資訊，請參見 GtkCssProvider 。</translation>
    </message>
    <message>
        ...
        <translation>所要使用的圖示主題的名稱。有關 GTK 如何處理圖示主題的詳細資訊，請參見 GtkIconTheme。</translation>
    </message>
    <message>
        ...
        <translation>是否 GTK 應保留最近使用的資源列表項目的追蹤。如果設定為 %1 ，則列表將總是空白。</translation>
    </message>
    <message>
        ...
        <translation>最近使用的資源列表項目的最大期限日數。大於此設定的項目將從列表中剔除。若是設定為 0，則列表將總是空白；如果設定為 -1，則不會有任何項目會被移除。</translation>
    </message>
    <message>
        ...
        <translation>此 XDG 音效主題使用於事件音效。有關事件音效和音效主題的更多資訊，請參見音效主題規格。 GTK 本身不支援事件音效，您必須使用像是 Libcanberra 隨附的可載入模組。</translation>
    </message>
    <message>
        ...
        <translation>所要使用的預設字型。 GTK 使用來自此字串的系列名稱及大小。</translation>
    </message>
    <message>
        ...
        <translation>所偏好的顏色方案用於使用者介面。有效值為：</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>是否捲軸應為疊覆作為指標。根據所使用的輸入裝置，永久性滾軸仍會顯示。</translation>
    </message>
    <message>
        ...
        <translation>記住最近使用檔案的天數。最近使用檔案將會在這天數內被記住。如果設定為 0，則不會記住最近檔案；如果設定為 -1，則會無限期保留。</translation>
    </message>
    <message>
        ...
        <translation>當渲染字型所用抗鋸齒的類型。可能值為： %1 用於無抗鋸齒。 %2 用於標準灰階抗鋸齒。 %3 用於次像素抗鋸齒(僅 LCD 螢幕)。</translation>
    </message>
    <message>
        ...
        <translation>渲染字體時所要使用的微調類型。可能的值為： %1 沒有微調。 %2 僅適用於 Y-axis 像是 Microsoft 的 ClearType、DirectWrite 及 Adobe 的專有字型渲染引擎。忽略字型內的原生暗示，會生成演算的微調。依照預設是由 Ubuntu 所使用。乃眾所建議的。%3 及 %4 的意義取決於字型格式 (.ttf, .otf, .pfa/.pfb) 及 FreeType 所安裝的版本。他們通常試圖將字型符合於 X Y 軸(除了用於 .otf: Y-only)。這可能會導致失真且/或不一致的呈現，取決於字型的品質、字型格式、及 FreeType 的字型引擎狀態。</translation>
    </message>
    <message>
        ...
        <translation>LCD 螢幕次像素的順序；僅使用在當抗鋸齒設定為 %1 時。可能的值為： %2 為紅色在左(最常見)。 %3 為藍色在左。 %4 為紅色在上。 %5 為紅色在下。</translation>
    </message>
    <message>
        <location filename="../../src/ToolTips.cpp" line="192"/>
        <source>The XDG sound theme to use for event sounds.</source>
        <translation>XDG 音效主題用於事件音效。</translation>
    </message>
    <message>
        ...
        <translation>是否滾動視窗可以使用疊覆的捲軸指示器。如果設定為 %1 ，則滾動視窗將會具有永久性的滾軸列。</translation>
    </message>
    <message>
        ...
        <translation>如果設定值為 %1 ，請點按 &lt;b&gt; GtkRange &lt;/b&gt; 中的主要按鈕，將會移動滑鍵，因此將範圍的值設定為您所點按之處。如果是 %2 ，則點按會造成滑鍵/值，按範圍的頁面大小移動到點按處。無論您為主按鈕選擇哪種操作，其它動作將為可行，藉由按住&lt;b&gt; Shift &lt;/b&gt;和 點按，或是點按滑鼠中鍵。</translation>
    </message>
    <message>
        ...
        <translation>是否使用抗鋸齒字型。其值為：0 為否。1 為是，或 %1 為系統預設。</translation>
    </message>
    <message>
        ...
        <translation>是否啟用字型微調。其值為：0 為否。1為是，或 %1 為系統預設。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>次像素抗鋸齒所使用的類型。可能值是 %1。請注意 GSK 不支援次像素抗鋸齒，並且此設定對於 GTK 中的字型渲染沒有影響。</translation>
    </message>
    <message>
        ...
        <translation>是否要記住最近使用的檔案。如果 %1，應用程序將不會記住最近使用的檔案。</translation>
    </message>
    <message>
        <location filename="../../src/ToolTips.cpp" line="197"/>
        <source>Name of the default font used by gtk+.</source>
        <translation>預設字型名稱，由 gtk+ 所使用。</translation>
    </message>
</context>
<context>
    <name>QObject</name>
